...
/*
    @Override
    public void setMessage(String to,String subject,String token)  {
        ...
        try {
            ...
            mailHelper = new MimeMessageHelper(message,MimeMessageHelper.MULTIPART_MODE_MIXED_RELATED, StandardCharsets.UTF_8.name());
            ...
            mailHelper.setText("",
                    "<!DOCTYPE html>\n" +
                            ...
                            "<tr><td class='pad' style='width:100%;padding-right:0px;padding-left:0px;'><div align='center' class='alignment' style='line-height:10px'><img alt='Your Logo' src='https://pgsintl.com/wp-content/uploads/2023/06/cropped-logo@200.png' style='display: block; height: auto; border: 0; width: 130px; max-width: 100%;' title='PGS INTERNATIONAL' width='130'/></div>\n" +
                            ...
                            "<div style='font-family: sans-serif'>\n" +
                            "<div class='' style='font-size: 14px; font-family: Roboto Slab, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 16.8px; color: #3f4d75; line-height: 1.2;'>\n" +
                            "<p style='margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;'><span style='font-size:22px;'>Let's get your code.</span></p>\n" +
                            "</div>\n" +
                            "</div>\n" +
                            "</td>\n" +
                            "</tr>\n" +
                            ...
                            "<a style='text-decoration:none;display:inline-block;color:#ffffff;background-color:#0e9695;border-radius:10px;width:auto;border-top:3px solid #3F4D75;font-weight:undefined;border-right:3px solid #3F4D75;border-bottom:3px solid #3F4D75;border-left:3px solid #3F4D75;padding-top:10px;padding-bottom:10px;font-family:Roboto Slab, Arial, Helvetica Neue, Helvetica, sans-serif;font-size:18px;text-align:center;mso-border-alt:none;word-break:keep-all;' target='_blank'><span style='padding-left:25px;padding-right:25px;font-size:18px;display:inline-block;letter-spacing:normal;'><span dir='ltr' style='word-break: break-word;'><span data-mce-style='' dir='ltr' style='line-height: 36px;'>"+token+"</span></span></span></a>\n" +
                            "</div>\n" +
                            "</td>\n" +
                            "</tr>\n" +
                            "</table>\n" +
